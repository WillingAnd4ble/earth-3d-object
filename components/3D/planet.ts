...
height: window.innerHeight,
  ...
  const atmoshphere = new THREE.Mesh(atmosphereGeometry, atmosphereMaterial);
  atmoshphere.scale.set(1.13,1.13,1.13);

  const earthGroup = new THREE.Group().add(earth, atmoshphere);
